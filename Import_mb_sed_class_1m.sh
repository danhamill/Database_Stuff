...
xyz=$(find C:/workspace/Reach_4a/Multibeam/xyz/2012_05/merge/ | egrep "1m.xyz")
sed5=$(find C:/workspace/Reach_4a/Multibeam/mb_sed_class/ | egrep "*5class_1m.xyz")
sed3=$(find C:/workspace/Reach_4a/Multibeam/mb_sed_class/ | egrep "*3class_1m.xyz")
stdev=$(find C:/workspace/Reach_4a/Multibeam/xyz/2012_05/stats/1m/ | egrep "*resampled_1m.txt")

#Build Tables
survey='mb_may_2012_1m'
tablename='tmp1'
tablename2='tmp21'
tablename3='tmp31'
tablename4='tmp4'
