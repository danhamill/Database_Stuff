...
ssfiles=$(find C:/workspace/Reach_4a/window_analysis/10_percent_Shift/2014_04/120/  | egrep "R[0-9]{5}x_y_ss_raw[0-9]{1,2}.asc")
texfiles=$(find C:/workspace/Reach_4a/window_analysis/10_percent_Shift/2014_04/120/  | egrep "*R[0-9]{5}x_y_class[0-9]{1,2}.asc")
